...
namespace VRPortal.Utilities.StringMetricAlgorithms {
    public static class JaroWinklerDistance {
        ...
        /// <param name="comparer">Comparer used to determine character equality.</param>
        /// <returns></returns>
        public static double Proximity (string s1, string s2, IEqualityComparer<char> comparer = null) {
            string aString1 = Regex.Replace (s1, @"\s+", "");
            string aString2 = Regex.Replace (s2, @"\s+", "");
